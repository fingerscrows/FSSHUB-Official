-- [[ FSSHUB LIBRARY: V18.2 (VERBOSE & FULL INTEGRITY) ]] --
-- Changelog: Expanded code structure to match original length, no compression.
...
function library:Watermark(headerText)
    ...
    if self.base:FindFirstChild("FSS_Watermark") then 
        self.base.FSS_Watermark:Destroy() 
    end
...
function library:SetWatermarkAlign(align)
    ...
    if align == "Top Left" then 
        self.wm_obj.AnchorPoint = Vector2.new(0, 0)
        self.wm_obj.Position = UDim2.new(0.01, 0, 0.01, 0)
    elseif align == "Top Right" then 
        self.wm_obj.AnchorPoint = Vector2.new(1, 0)
        self.wm_obj.Position = UDim2.new(0.99, 0, 0.01, 0)
    elseif align == "Bottom Left" then 
        self.wm_obj.AnchorPoint = Vector2.new(0, 1)
        self.wm_obj.Position = UDim2.new(0.01, 0, 0.99, 0)
    elseif align == "Bottom Right" then 
        self.wm_obj.AnchorPoint = Vector2.new(1, 1)
        self.wm_obj.Position = UDim2.new(0.99, 0, 0.99, 0) 
    end
end
...
function library:Window(title)
    ...
    function window:Section(name, iconId) 
        ...
        local TabLabel = Create("TextLabel", {
            ...
            Position = UDim2.new(0, textOffset + 5, 0, 0),
            BackgroundTransparency = 1, 
            TextXAlignment = Enum.TextXAlignment.Left
        })
        ...
        function tab:Dropdown(text, options, default, callback, parent)
             ...
             Btn.MouseButton1Click:Connect(function() 
                 ...
                 local h = isDropped and (36 + (#options * 30) + 10) or 36
             ...
             for _, opt in ipairs(options) do 
                ...
                library:RegisterTheme(B, "TextColor3", "TextDim")
